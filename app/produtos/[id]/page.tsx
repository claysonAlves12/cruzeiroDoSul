...
const ProductPage: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({ open: true, description: 'Produto atualizado com sucesso!', variant: 'success' });

      setProduct(tempProduct);
      setIsEditing(false);
    } catch (error:unknown) {
      const errorMessage = error instanceof Error ? error.message : 'Erro desconhecido';
      toast({ open: true, description: `Erro ao salvar alterações: ${errorMessage}`, variant: 'destructive' });
    }
  };
              ...
              <>
                <div className='flex w-full '>
                  <div className="flex flex-col items-center justify-center w-full">
                    ...
                    >
                      <Image
                        src={tempProduct?.imageUrl || "/semFoto.png"}
